 ...
 */
@Entity
@Table(name = "page", catalog = "simplewikidb", uniqueConstraints = @UniqueConstraint(columnNames = "pageId"))
public class Page implements java.io.Serializable {
	...
	public Page(Integer pageId, String name, String text, Boolean isDisambiguation) {
		this.pageId = pageId;
		this.name = name;
		this.text = text;

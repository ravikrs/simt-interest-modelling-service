 ...
 */
@Embeddable
public class PageInlinksId implements java.io.Serializable {

	private long id;
	private Integer inLinks;

	public PageInlinksId() {
	}

	public PageInlinksId(long id) {
		this.id = id;
	}

	public PageInlinksId(long id, Integer inLinks) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PageInlinksId))
			return false;
		PageInlinksId castOther = (PageInlinksId) other;

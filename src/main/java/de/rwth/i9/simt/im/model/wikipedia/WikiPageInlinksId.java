...
/**
 * PageInlinksId generated by hbm2java
 */
@Embeddable
public class WikiPageInlinksId implements java.io.Serializable {

	private long id;
	private Integer inLinks;

	public WikiPageInlinksId() {
	}

	public WikiPageInlinksId(long id) {
		this.id = id;
	}

	public WikiPageInlinksId(long id, Integer inLinks) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WikiPageInlinksId))
			return false;
		WikiPageInlinksId castOther = (WikiPageInlinksId) other;
